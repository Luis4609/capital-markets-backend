...
//@SpringBootTest()
class CurrencyAdapterTestIntegration {
//    @Autowired
...
//    @Test
    void getConversion() {
        ...
        CurrencyConverterDTO result = currencyAdapter.getConversion(10.5, "GBP", "USD");
...
//    @Test
    void getHistorical() {
        ...
        CurrencyHistoricalDTO result = currencyAdapter.getHistorical("2022-08-23", 5, "EUR", "GBP");
        assertThat(result).isNotNull();
        assertThat(result.getTo()).isNotEmpty();
...
//    @Test
    void getInterval() {
        ...
        CurrencyHistoricalDTO result = currencyAdapter.getInterval("2022-08-23","2022-08-24",30,"USD","GBP");
        assertThat(result).isNotNull();
        assertThat(result.getTo()).isNotEmpty();
        assertThat(result.getBase()).isNotEmpty();
        assertThat(result.getConversion()).isNotEmpty();
