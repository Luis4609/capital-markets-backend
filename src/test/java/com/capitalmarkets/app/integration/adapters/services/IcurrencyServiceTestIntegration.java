...
//    @Test
    void getHistorical() {
        ...
        CurrencyHistoricalDTO result = icurrencyService.getHistorical("2022-08-23", 5, "EUR", "GBP");
        assertThat(result).isNotNull();
        assertThat(result.getTo()).isNotEmpty();
...
//    @Test
    void getInterval() {
        ...
        CurrencyHistoricalDTO result = icurrencyService.getInterval("2022-08-23", "2022-08-24", 30, "USD", "GBP");
        assertThat(result).isNotNull();
        assertThat(result.getTo()).isNotEmpty();
        assertThat(result.getBase()).isNotEmpty();
        assertThat(result.getConversion()).isNotEmpty();
