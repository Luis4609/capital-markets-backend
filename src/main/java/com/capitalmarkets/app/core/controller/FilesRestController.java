...
public class FilesRestController {
    ...
    public HashMap<String, Object> getHistoricalPdf(@RequestBody CurrencyHistoricalDTO dto) throws IOException, IllegalAccessException {
        ...
        String path = "C:\\Users\\luis.monzon\\Documents\\capital-markets\\src\\main\\resources\\files\\historical.pdf";
        String PATH_TO_PUBLIC_FRONT = "C:\\Users\\luis.monzon\\Documents\\capitalmarketsfront\\public\\historical.pdf";
        ...
        PdfDocument pdfDoc = new PdfDocument(new PdfWriter(PATH_TO_PUBLIC_FRONT));
    ...
    private void infoPdf2(Document doc, CurrencyHistoricalDTO text) throws IOException {
        ...
        Image img = new Image(ImageDataFactory.create("C:\\Users\\luis.monzon\\Documents\\capital-markets\\src\\main\\resources\\img\\CM.png"));
        img.setWidth(120);
        img.setHeight(120);
    ...
    private void dataPdf2(Document doc, CurrencyHistoricalDTO texto) throws IOException {
        ...
        Image img = new Image(ImageDataFactory.create("C:\\Users\\luis.monzon\\Documents\\capital-markets\\src\\main\\resources\\img\\footer.png"));
        img.setWidth(200);
        img.setHeight(70);
